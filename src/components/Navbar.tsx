...
export default function Navbar() {
  ...
  return (
    <nav className="md:block fixed top-0 w-full border-b border-white/20 z-50 bg-white/80 backdrop-blur-xl border-b border-slate-200/50 shadow-[0_30px_30px_-5px_rgba(0,65,101,0.08)]">
        ...
        <div className="hidden md:flex space-x-8 items-center h-full">
          {navItems.map((item) => (
            <a
              ...
              className={`font-h3 text-xl tracking-tight transition-colors duration-200 mt-2 ${active === item.id
