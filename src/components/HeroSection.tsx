    ...
    <section className="relative min-h-[921px] flex items-center overflow-hidden pt-20">
      ...
      <div className="max-w-[1200px] mx-auto px-6 w-full relative z-10 grid md:grid-cols-2 gap-12 items-center">
        ...
        <motion.div 
          ...
          className="text-white space-y-8 py-12 md:py-0"
        >
          <div className="inline-block px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 font-label-caps text-sm text-brand-yellow mb-4">
            Division T Director Candidate
          </div>
          <h1 className="font-h1 text-5xl md:text-7xl text-white drop-shadow-lg font-bold leading-tight">
            Leela Rani <br />Eagappan
          </h1>
          <p className="font-h3 text-2xl text-white/90 max-w-lg leading-relaxed">
            Empowering Independent Leaders & Inclusive Clubs
          </p>
          <div className="pt-6">
            <a 
          ...
          <div className="glass-panel p-4 rounded-[2rem] max-w-sm w-full transform rotate-2 hover:rotate-0 transition-transform duration-500 shadow-2xl group">
            <div className="aspect-[3/4] rounded-2xl overflow-hidden bg-surface-container relative">
              <img 
                ...
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuBUoqWRp_5VsYSIokm1-J3O2gzZfQkduuOvFQRKJCcZGRvHUN3-K9WsjDj-GO66zd-NYJvN_dCCh00bQudKpulsaXEk2LBxMqEg109IsnguKJ90Qorm1eR0za0ZBrV4oGvwTDUruqIAr4oau7t40l3yVjI7vfvTvKKhZbF32aFx-0UGnSHA0HblE_CGhZ9oe2Y7odOdj1jS0dgaBjVL-_JFABGm137VE37yYdhdYl8x8bT5CzNyJi69uiuPiG4JGbu9PfX1nWgZAsk"
              />
            </div>
